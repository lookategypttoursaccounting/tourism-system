...
const translations = {
  ar: {
    ...
    // ===== شاشة الدخول (Login) =====
    login_title: "منظومة الحسابات السياحية",
    login_subtitle: "اختر نوع الدخول للمتابعة",
    login_role_admin: "الحسابات",
    login_role_tourism: "السياحة",
    login_pin_placeholder: "أدخل رمز الدخول",
    login_error: "رمز الدخول غير صحيح",
    login_logout: "🚪 تسجيل الخروج",
    change_admin_pin: "🔑 تغيير رمز الحسابات",
    admin_pin_prompt: "أدخل رمز الحسابات الجديد:",
    admin_pin_changed: "تم تغيير رمز الحسابات بنجاح",
    preview_tourism: "🌍 معاينة قسم السياحة",

    // ===== قسم السياحة (Tourism) =====
    tourism_login_title: "🔐 الدخول إلى قسم السياحة",
    tourism_login_hint: "هذا القسم مخصص للموظفين. أدخل رمز الدخول للمتابعة.",
    tourism_login_placeholder: "أدخل رمز الدخول",
    tourism_login_error: "رمز الدخول غير صحيح، حاول مرة أخرى.",
    tourism_header_title: "🌍 منظومة السياحة",
    tourism_header_subtitle: "واجهة الموظفين — عرض فقط",
    tourism_exit: "🚪 خروج",
    tourism_sub_tickets_balance: "🎟️ أرصدة التذاكر",
    tourism_sub_credit_summary: "💳 أرصدة الكريديت",
    tourism_change_pin: "🔑 تغيير رمز قسم السياحة",
    tourism_pin_prompt: "أدخل رمز الدخول الجديد لقسم السياحة:",
    tourism_pin_changed: "تم تغيير رمز الدخول بنجاح",
    tourism_pin_invalid: "الرمز يجب أن يكون 4 أرقام على الأقل",
    tourism_welcome: "مرحبًا بك في قسم السياحة",
    btn_enter: "دخول",
    ...
    sub_credit_statement: "4- كشف حساب",
    ...
    dash_report_p: "LOOK ATEGYPT TOURS — The Luxury DMC of Egypt",
  ...
  en: {
    ...
    // ===== Login Screen =====
    login_title: "Tourism Accounts System",
    login_subtitle: "Choose the login type to continue",
    login_role_admin: "Accounts",
    login_role_tourism: "Tourism",
    login_pin_placeholder: "Enter access code",
    login_error: "Incorrect access code",
    login_logout: "🚪 Logout",
    change_admin_pin: "🔑 Change Accounts Code",
    admin_pin_prompt: "Enter the new accounts code:",
    admin_pin_changed: "Accounts code changed successfully",

    // ===== Tourism Section =====
    tourism_login_title: "🔐 Tourism Section Login",
    tourism_login_hint: "This section is for employees. Enter the access code to continue.",
    tourism_login_placeholder: "Enter access code",
    tourism_login_error: "Incorrect access code, please try again.",
    tourism_header_title: "🌍 Tourism System",
    tourism_header_subtitle: "Employee View — Read Only",
    tourism_exit: "🚪 Exit",
    tourism_sub_tickets_balance: "🎟️ Ticket Balances",
    tourism_sub_credit_summary: "💳 Credit Balances",
    tourism_change_pin: "🔑 Change Tourism Access Code",
    tourism_pin_prompt: "Enter the new access code for the Tourism section:",
    tourism_pin_changed: "Access code changed successfully",
    tourism_pin_invalid: "The code must be at least 4 digits",
    tourism_welcome: "Welcome to the Tourism section",
    btn_enter: "Enter",
    ...
    sub_credit_statement: "4- Account Statement",
...
function applyTranslations() {
  ...
  const tourismLangBtn = document.getElementById('tourismLangToggleBtn');
  if (tourismLangBtn) tourismLangBtn.textContent = dict.lang_toggle;
}
